...
driver.get("https://www.tutorialspoint.com/how-to-handle-frames-in-selenium-with-python")
...
Examples in above links
https://the-internet.herokuapp.com/nested_frames --> consider this for assignment
'''
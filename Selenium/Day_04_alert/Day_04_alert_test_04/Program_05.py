...
#login_button.click() -> login alert will not be generated
time.sleep(1)
alert = wait.until(expected_conditions.alert_is_present()) #output: raise TimeoutException(message, screen, stacktrace)
alert.accept()
time.sleep(1)

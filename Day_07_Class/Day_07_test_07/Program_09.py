class Student:
    college = "IIT"
    uniform = "White & Grey"
    def __init__(self, name, id, section): #__init__ is a special method called as constructor which gets executed automatically at the time of object creation.
...
obj1 = Student("Rahul", 101, "X") #output: Inside the constructor of Student class
...
print(obj1.section) #output: X
print(obj2.section) #output: Z

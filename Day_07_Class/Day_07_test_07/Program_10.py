class Student:
    ...
    @classmethod
    def display_uniform(cls, section): #cls signifies it is class method.
        cls.section = section
        print(cls.college, cls.uniform, cls.section) #when using class or static variable we use cls method instead of instance method(self)
...
obj1.display_uniform("A") #output: IIT White & Grey
...
obj2.display_uniform("B")  #output: IIT White & Grey
print(obj2.maximum_of_two_numbers(15, 5))  #output: 15

print(obj1.section) #updated due to line 31 object initiation.
